...
| Solving method for bones between pelvis and chest| |
...
| Interpolation multiplier relative to velocity curve | |
...
| Accurate-Simple foot placement curve relative to velocity curve | |
...
| Parameter | Description                          |
|:----------|:-------------------------------------|
| Stabilize legs connected to pelvis during body bending ?  | |
| (Upslope) Pelvic legs stabilization alpha  | |
| (Downslope) Pelvic legs stabilization alpha  | |
| Stabilize legs connected to chest during body bending ?  | |
| (Upslope) Chest legs stabilization alpha  | |
| (Downslope) Chest legs stabilization alpha  | |
| (optional) Head bone to be stabilized  | |
| (optional) Tail bone to be stabilized  | |
...
| [Pelvis/Chest] dip height multiplier relative to velocity | |
